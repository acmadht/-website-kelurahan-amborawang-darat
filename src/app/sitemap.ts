...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/permohonan-surat`, changeFrequency: "weekly", priority: 0.9 },
    { url: `${SITE_URL}/cek-surat`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/pengaduan`, changeFrequency: "weekly", priority: 0.9 },
    { url: `${SITE_URL}/cek-pengaduan`, changeFrequency: "weekly", priority: 0.7 },
    ...
    { url: `${SITE_URL}/data-publik`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${SITE_URL}/transparansi`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${SITE_URL}/privasi`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${SITE_URL}/penduduk`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/keluarga`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/mutasi`, changeFrequency: "weekly", priority: 0.6 },
    { url: `${SITE_URL}/bansos`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/inventaris`, changeFrequency: "weekly", priority: 0.6 },
    { url: `${SITE_URL}/umkm`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/fasilitas`, changeFrequency: "weekly", priority: 0.7 },
